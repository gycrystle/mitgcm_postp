...
plt.plot(W_btp1[17,pltc:pltd,90]*conv_factor, y_btp, color='b', label='BTa_1')
plt.plot(W_btp2[17,pltc:pltd,90]*conv_factor, y_btp, color='b', ls='dashed', label='BTa_2')
plt.plot(W_brc1[25,plta:pltb,165]*conv_factor, y_brc, color='r', label='BCa_1')
plt.plot(W_brc2[25,plta:pltb,165]*conv_factor, y_brc, color='r', ls='dashed', label='BCa_2')
...
plt.savefig("./figures/ancyclone_btp_brc.png")
...
ax2.plot(W_btp1[:,104,90]*conv_factor, RC_btp[:].squeeze(), color='b', label='BTa_1')
ax2.plot(W_btp2[:,104,90]*conv_factor, RC_btp[:].squeeze(), color='b', ls='dashed', label='BTa_2')
ax2.plot(W_brc1[:,194,165]*conv_factor, RC_brc[:].squeeze(), color='r', label='BCa_1')
ax2.plot(W_brc2[:,194,165]*conv_factor, RC_brc[:].squeeze(), color='r', ls='dashed', label='BCa_2')

plt.tight_layout(pad=1)
ax2.legend(loc='lower right')
plt.savefig('./figures/Wmean_profile_ancyclone.png')
...
ax2.plot(W_btp1[:,70,90]*conv_factor, RC_btp[:].squeeze(), color='b', label='BTa_1')
ax2.plot(W_btp2[:,70,90]*conv_factor, RC_btp[:].squeeze(), color='b', ls='dashed', label='BTa_2')
ax2.plot(W_brc1[:,124,165]*conv_factor, RC_brc[:].squeeze(), color='r', label='BCa_1')
ax2.plot(W_brc2[:,124,165]*conv_factor, RC_brc[:].squeeze(), color='r', ls='dashed', label='BCa_2')

plt.tight_layout(pad=1)	
ax2.legend(loc='lower right')
plt.savefig('./figures/Wmean_profiledown_ancyclone.png')
