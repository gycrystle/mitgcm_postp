...
#itrs=[0,1,20,120,360]#480,960,1440,1920,2400,7200]#,480,960,1440,1920,2400]
nit=itrs.size
#nit=5

vr_range=np.linspace(-0.3, 0.3, 100, endpoint=True)
vr_ticks = np.linspace(-0.3, 0.3, 11, endpoint=True)
vt_range=np.linspace(-0.5, 0, 100, endpoint=True)
vt_ticks = np.linspace(-0.5, 0, 11, endpoint=True)
